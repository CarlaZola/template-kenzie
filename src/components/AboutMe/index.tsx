    ...
    return(
        <AboutMeContainer>     
            <AboutMeFlex >
                ...
                Atualmente estudo <Text as="span" type="body1" color="brand1">
                desenvolvimento web
              </Text>{""}, aprendendo como abstrair ideias e transformá-las em programas com soluções, seguindo algumas lógicas e fluxogramas!
